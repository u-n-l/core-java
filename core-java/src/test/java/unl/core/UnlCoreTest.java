...
public class UnlCoreTest {
    ...
    public void encode() {
        ...
        /* encodes Jutland */
        Assert.assertEquals(unlCoreInstance.encode(57.648, 10.41, 6), "u4pruy");
        /* encodes Jutland floor 5 */
        Assert.assertEquals(unlCoreInstance.encode(57.648, 10.41, 6, new Elevation(5)), "u4pruy@5");
        /* encodes Jutland floor -2 */
        Assert.assertEquals(unlCoreInstance.encode(57.648, 10.41, 6, new Elevation(-2)), "u4pruy@-2");
        /* encodes Jutland heightincm 87 */
        Assert.assertEquals(unlCoreInstance.encode(57.648, 10.41, 6, new Elevation(87, "heightincm")), "u4pruy#87");
        /* encodes Jutland with default precision 9 */
        Assert.assertEquals(unlCoreInstance.encode(57.64, 10.41), "u4pruvh36");
        /* encodes Curitiba */
        Assert.assertEquals(unlCoreInstance.encode(-25.38262, -49.26561, 8), "6gkzwgjz");
        /* matches locationId */
        Assert.assertEquals(unlCoreInstance.encode(37.25, 123.75, 12), "wy85bj0hbp21");
    }
    ...
    public void decode() {
        ...
        /* decodes Jutland */
        Assert.assertEquals(unlCoreInstance.decode("u4pruy"),
                new PointWithElevation(new Point(57.648, 10.41), defaultElevation, new BoundsWithElevation(new Bounds(
                        new Point(57.645263671875, 10.404052734375),
                        new Point(57.6507568359375, 10.4150390625)
                ), defaultElevation)));

        /* decodes Justland floor 3 */
        Assert.assertEquals(unlCoreInstance.decode("u4pruy@3"),
        ...
        Assert.assertEquals(unlCoreInstance.decode("u4pruy@0"),
                new PointWithElevation(new Point(57.648, 10.41),
                        defaultElevation,
                        new BoundsWithElevation(new Bounds(
                                new Point(57.645263671875, 10.404052734375),
        ...
        Assert.assertEquals(unlCoreInstance.decode("u4pruy@-2"),
                new PointWithElevation(new Point(57.648, 10.41),
        ...
        Assert.assertEquals(unlCoreInstance.decode("u4pruy#87"),
                new PointWithElevation(new Point(57.648, 10.41),
        ...
        /* decodes Curitiba */
        Assert.assertEquals(unlCoreInstance.decode("6gkzwgjz"),
        ...
        Assert.assertEquals(unlCoreInstance.decode("6gkzwgjz@5"),
                new PointWithElevation(new Point(-25.38262, -49.26561),
        ...
        Assert.assertEquals(unlCoreInstance.decode("6gkzwgjz#90"),
                new PointWithElevation(new Point(-25.38262, -49.26561),
    ...
    public void appendElevation() {
        ...
        Assert.assertEquals(unlCoreInstance.appendElevation("6gkzwgjz", new Elevation(5)),
                "6gkzwgjz@5"
        );

        /* appends elevation Curitiba above 87cm */
        Assert.assertEquals(unlCoreInstance.appendElevation("6gkzwgjz", new Elevation(87, "heightincm")),
                "6gkzwgjz#87"
        );
    }
    ...
    public void excludeElevation() {
        ...
        Assert.assertEquals(unlCoreInstance.excludeElevation("6gkzwgjz@5"),
        ...
        Assert.assertEquals(unlCoreInstance.excludeElevation("6gkzwgjz#87"),
                new LocationIdWithElevation(
                        "6gkzwgjz",
                        new Elevation(87, "heightincm")
                )
    ...
    public void adjacent() {
        ...
        /* adjacent north */
        Assert.assertEquals(unlCoreInstance.adjacent("ezzz@5", "n"), "gbpb@5");
    }
    ...
    public void gridLines() {
        ...
        Assert.assertEquals(unlCoreInstance.gridLines(
                new Bounds(
